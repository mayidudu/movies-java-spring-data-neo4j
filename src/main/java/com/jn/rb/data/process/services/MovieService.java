...
import com.jn.rb.data.process.domain.Movie;
import com.jn.rb.data.process.repositories.MovieRepository;
import com.jn.rb.data.process.domain.Role;
...
public class MovieService {
	...
	public Map<String, Object>  graph(int limit) {
		...
		System.out.println("==movie-graph===");
